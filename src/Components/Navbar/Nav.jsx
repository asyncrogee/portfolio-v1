  ...
  return (
    <div className="flex flex-col justify-between w-[23rem]">
          ...
          <ul className="flex flex-col gap-1">
            ...
            <li className="flex gap-1">
              <img
                ...
                alt="Location Icon"
              />
              <span className="text-xs text-grei text-nowrap">
      ...
      <div className="flex gap-4 min-h-72">
        ...
        <ul className="flex flex-col justify-between h-full">
          <li>
            <a className="hover:text-redd" href="#">
              ABOUT ME
            </a>
          </li>
          <li>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between">
          <a
            className="flex p-1 gap-1 bg-darkblue/20 border-darkblue border-[0.3px] rounded items-center"
            href="https://www.linkedin.com/in/jrogeet/"
            target="_blank"
          >
            <img
              className="h-4"
          ...
          <a
            className="flex p-1 gap-1 bg-coalblack/20 border-coalblack border-[0.3px] rounded items-center"
            href="https://github.com/asyncrogee"
            target="_blank"
          >
          ...
          <a
            className="flex p-1 gap-1 bg-redd/20 border-redd border-[0.3px] rounded items-center"
            href="https://www.instagram.com/asyncrogee/"
            target="_blank"
          >
            <img
              className="h-4"
